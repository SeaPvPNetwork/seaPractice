...
public class DivisionCommand extends BaseCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        if (player.hasPermission("alley.admin")) {
            ...
            player.sendMessage(CC.translate(" &f● &c/division delete &8(&7divisionName&8) &7| Delete a division"));
            player.sendMessage(CC.translate(" &f● &c/division view &8(&7divisionName&8) &7| View division info"));
            player.sendMessage(CC.translate(" &f● &c/division setwins &8(&7divisionName&8) &8(&7requiredWins&8) &8(&7tier&8) &7| Set required wins of a tier"));
            player.sendMessage(CC.translate(" &f● &c/division seticon &8(&7divisionName&8) &7| Set division icon"));
            player.sendMessage(CC.translate(" &f● &c/division setdisplayname &8(&7divisionName&8) &8(&7displayName&8) &7| Set division display name"));
            player.sendMessage(CC.translate(" &f● &c/division setdescription &8(&7divisionName&8) &8(&7description&8) &7| Set division description"));
            player.sendMessage(CC.translate(" &f● &c/division menu &7| Open the division menu"));
            player.sendMessage(CC.translate(" &f● &c/division list &7| View all divisions"));
            player.sendMessage("");
            return;
        }
