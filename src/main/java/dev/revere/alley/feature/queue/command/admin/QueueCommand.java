...
public class QueueCommand extends BaseCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        sender.sendMessage(CC.translate(" &f● &6/queue force &8(&7player&8) &8(&7kit&8) &8<&7ranked&8> &7| Force a model into a queue"));
        //sender.sendMessage(CC.translate(" &f● &6/queue remove &8(&7player&8) &7| Remove a model from queue"));
