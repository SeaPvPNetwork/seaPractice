    ...
    public ItemStack getButtonItem(Player player) {
        ...
        return new ItemBuilder(Material.SKULL_ITEM)
                ...
                .lore(
                        ...
                        "",
                        "&c&lUnranked",
                        "&7│ &fWins: &c" + profile.getProfileData().getUnrankedWins(),
                        "&7│ &fLosses: &c" + profile.getProfileData().getUnrankedLosses(),
                        "",
                        "&c&lRanked",
                        "&7│ &fWins: &c" + profile.getProfileData().getRankedWins(),
                        "&7│ &fLosses: &c" + profile.getProfileData().getRankedLosses(),
                        "&7│ &fElo: &c" + profile.getProfileData().getElo(),
                        "",
                        "&c&lFFA",
                        "&7│ &fKills: &c" + ffaKills,
                        "&7│ &fDeaths: &c" + ffaDeaths,
                        "",
                        "&c&lAccount",
                        "&7│ &fRank: &c" + coreAdapter.getCore().getRankColor(target.getPlayer()) + coreAdapter.getCore().getRankName(target.getPlayer()),
                        "&7│ &fCoins: &c$" + profile.getProfileData().getCoins(),
                        "&7│ &fLevel: &c" + levelService.getLevel(profile.getProfileData().getGlobalLevel()).getDisplayName(),
                        CC.MENU_BAR
