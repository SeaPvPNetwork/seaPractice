...
public abstract class BaseCommand {
    ...
    /**
     * Either fetches the profile of an online model or retrieves the offline profile.
     *
     * @param target The name of the model.
     * @param sender The command sender.
     * @return The profile of the model, or null if not found.
     */
    public Profile getOfflineProfile(String target, CommandSender sender) {
        ...
        if (offlinePlayer == null) {
            sender.sendMessage(CC.translate("&cThat model does not exist."));
            return null;
        }

        UUID uuid = offlinePlayer.getUniqueId();
        if (uuid == null) {
            sender.sendMessage(CC.translate("&cThat model is invalid."));
            return null;
        }
        ...
        if (profile == null) {
            sender.sendMessage(CC.translate("&cThat model does not have a profile."));
            return null;
        }
